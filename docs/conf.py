...
html_theme_options = {"flavor": "rocm-simulation", "repository_url": "https://github.com/AMD-Ecosystem/gsplat/"}
...
# Add more addtional packages accordingly
extensions = [
    "rocm_docs", 
...
external_projects_current_project = "GSplat"